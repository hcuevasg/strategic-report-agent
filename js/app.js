...
// ============================================================
// i18n — labels live in i18n.js, loaded before this script
// ============================================================
let currentLang = 'es';
...
// ============================================================
// result           — current report JSON (set after generation)
// originalResult   — pre-edit snapshot for "Restore" action
// progressTimer    — setInterval handle for the progress bar
// currentReportType — 'strategic' | 'financial' | 'operational' | 'risk' | 'competitive' | 'due_diligence' | 'general' | 'minuta'
// outputLanguage   — 'auto' | 'es' | 'en' | 'pt' | 'fr' | 'de'
// currentHistoryId — localStorage key of the report being edited
// _autoSaveTimer   — debounce handle for auto-save to localStorage
// chatHistory      — array of {role, content} for the AI chat panel
// _minutasFilter   — current search string in the minutas list
