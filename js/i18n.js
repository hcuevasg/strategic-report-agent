...
const i18n = {
  es: {
    ...
    qaReviewBtn: 'Auditar calidad',
    advReviewBtn: 'Estresar tesis',
    qaRunning: 'Auditando...',
    qaError: 'Error auditando',
    qaScore: 'Calidad',
    qaDetails: 'Ver detalle',
    qaDetailTitle: 'Auditoría de calidad del informe',
    qaActionability: 'Accionabilidad',
    qaEvidence: 'Evidencia',
    qaTone: 'Tono',
    qaBalance: 'Balance',
    qaConsistency: 'Consistencia',
    qaSpecificity: 'Especificidad',
    qaStrengths: 'Fortalezas',
    qaWeaknesses: 'Debilidades',
    qaFlags: 'Alertas',
    advRunning: 'Estresando...',
    advError: 'Error en estrés',
    advTitle: 'Contra-análisis (Abogado del Diablo)',
    advVerdict: 'Veredicto',
    advWeaknesses: 'Debilidades detectadas',
    advCounters: 'Contra-argumentos',
    advQuestions: 'Preguntas de estrés',
    advAssumptions: 'Asunciones frágiles',
  ...
  en: {
    ...
    qaReviewBtn: 'Audit quality',
    advReviewBtn: 'Stress-test thesis',
    qaRunning: 'Auditing...',
    qaError: 'Audit error',
    qaScore: 'Quality',
    qaDetails: 'View detail',
    qaDetailTitle: 'Report quality audit',
    qaActionability: 'Actionability',
    qaEvidence: 'Evidence',
    qaTone: 'Tone',
    qaBalance: 'Balance',
    qaConsistency: 'Consistency',
    qaSpecificity: 'Specificity',
    qaStrengths: 'Strengths',
    qaWeaknesses: 'Weaknesses',
    qaFlags: 'Flags',
    advRunning: 'Stress-testing...',
    advError: 'Stress-test error',
    advTitle: "Counter-analysis (Devil's Advocate)",
    advVerdict: 'Verdict',
    advWeaknesses: 'Weaknesses detected',
    advCounters: 'Counter-arguments',
    advQuestions: 'Stress questions',
    advAssumptions: 'Fragile assumptions',
